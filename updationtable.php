...
<div style="overflow-x:auto;">
    <table border="0px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 15px 15px;">
        <th colspan="4" style="text-align: center;background-color:skyblue; width: 145px; height: 50px;">UPDATE THE DETAILS</th>
        <tr>
